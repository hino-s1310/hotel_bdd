Feature: 既存会員でログインし、プランの予約を行う
  ...
  Scenario Outline: reserve_plan
    ...
    And 合計欄が「<reserve_total_bill>」であることを確認する
    ...
    Examples:
    | login_input | plan_name | reserve_input | reserve_total_bill | confirm_validate |
    | {"ログイン情報_入力": {"email": "ichiro@example.com", "password": "password"}} | お得な特典付きプラン | {"予約情報_入力": {"stay_num":"1", "people_num":"1", "flag_morning": "False", "flag_noon_checkin": "False", "flag_reasnable_sightseeing": "False", "reserve_contact":"希望しない"}} | 7,000 | {"予約確認情報_検証":{"confirm_total_bill":"7,000", "reserve_plan_name":"お得な特典付きプラン" ,"stay_num":"1" ,"additional_plan":"なし" ,"name":"山田一郎" ,"people_num":"1" , "confirm_contact":"希望しない","comment":"なし"}} |